...
export const DesktopAuthBridge: React.FC<DesktopAuthBridgeProps> = () => {
  ...
  return (
    <div className="min-h-screen bg-[#070707] text-[#e4e4e7] flex flex-col items-center justify-center p-6 font-sans">
      <div className="w-full max-w-md bg-[#0f0f10] border border-zinc-800/80 rounded-2xl p-8 space-y-6 flex flex-col items-center">
